...
def test_boundaries_contain_only_markers_and_common_foundations() -> None:
    allowed_files = {
        ...
        "domain/live_evidence/__init__.py",
        "domain/live_evidence/artifacts.py",
        "domain/live_evidence/authorization.py",
        "domain/live_evidence/canonical.py",
        "domain/live_evidence/citation_eligibility.py",
        "domain/live_evidence/document_bridge.py",
        "domain/live_evidence/enums.py",
        "domain/live_evidence/exceptions.py",
        "domain/live_evidence/execution_approval.py",
        "domain/live_evidence/gate_b_authorization.py",
        "domain/live_evidence/gate_b_pilot.py",
        "domain/live_evidence/gate_b_request_identity.py",
        "domain/live_evidence/file_security.py",
        "domain/live_evidence/html_security.py",
        "domain/live_evidence/incidents.py",
        "domain/live_evidence/json_security.py",
        "domain/live_evidence/manifests.py",
        "domain/live_evidence/manual.py",
        "domain/live_evidence/offline_pipeline.py",
        "domain/live_evidence/pdf_security.py",
        "domain/live_evidence/queries.py",
        "domain/live_evidence/retention.py",
        "domain/live_evidence/schemas.py",
        "domain/live_evidence/snapshot.py",
        "domain/live_evidence/validation.py",
        ...
        "domain/research_agent/claim_pipeline.py",
        ...
        "domain/research_agent/evidence_adapters.py",
        ...
        "infrastructure/manual_evidence_storage.py",
        ...
        "providers/sec_edgar/bootstrap.py",
        "providers/sec_edgar/endpoints.py",
        "providers/sec_edgar/policy.py",
        "providers/sec_edgar/request_identity.py",
        ...
        "tools/registry.py",
        "tools/schemas.py",
        "tools/schemas_live_evidence.py",
